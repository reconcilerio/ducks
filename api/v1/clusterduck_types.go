...
type ClusterDuck struct {
	...
	Spec   ClusterDuckSpec   `json:"spec,omitempty"`
	Status ClusterDuckStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ClusterDuckList contains a list of ClusterDuck.
type ClusterDuckList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ClusterDuck `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ClusterDuck{}, &ClusterDuckList{})
}
